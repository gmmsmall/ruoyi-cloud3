...
public class BaseInfoExcelForm implements Serializable {
    ...
    @ExcelField(value = "院士编号",width = 90)
    private Integer acadId;

    @ApiModelProperty(value = "头像")
    @ExcelField(value = "头像",width = 90)
    private String photo;//头像

    @ApiModelProperty("姓名")
    @ExcelField(value = "姓名",width = 90)
    private String acadName;//院士姓名，显示顺序为真实姓名、中文名字。英文名字

    @ApiModelProperty(value = "出生日期")
    @ExcelField(value = "出生日期",width = 90)
    private String birthday;//出生日期

    @ApiModelProperty("国籍")
    @ExcelField(value = "国籍",width = 90)
    private String nationPlace;//国籍（多个国籍拼接而成）

    @ApiModelProperty(value = "籍贯")
    @ExcelField(value = "籍贯",width = 90)
    private String nativePlace;//籍贯

    @ApiModelProperty("授衔机构")
    @ExcelField(value = "授衔机构",width = 90)
    private String aosName;//科学院（显示正籍的科学院）

    @ApiModelProperty("邮箱")
    @ExcelField(value = "邮箱",width = 90)
    ...
    @ExcelField(value = "研究领域",writeConverterExp = "1=高端装备制造,2=生物医药,3=新能源新材料,4=网络信息,5=设计研发,6=海洋经济,7=军民融合,8=其他",width = 90)
    ...
    @ExcelField(value = "联络方式",writeConverterExp ="1=邮箱,2=电话,3=邮箱/电话,4=未联络",width = 90)
