...
import com.ruoyi.fdfs.domain.RedisInfo;
import com.ruoyi.fdfs.function.JedisExecutor;
...
public class RedisServiceImpl implements RedisService {
    ...
    @Override
    public Long incrBy(String key, long integer) throws RedisConnectException {
        return this.excuteByJedis(j -> j.incrBy(key, integer));
    }

    @Override
    public List getListAll(String key) throws RedisConnectException {
        return this.excuteByJedis(j -> j.lrange(key, 0, -1));
    }
}
