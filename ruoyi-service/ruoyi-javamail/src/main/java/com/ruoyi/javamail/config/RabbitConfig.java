package com.ruoyi.javamail.config;
...
public class RabbitConfig {
    ...
    // 发送邮件
    public static final String MAIL_QUEUE_NAME = "mail.queue.academician.gmm";
    public static final String MAIL_EXCHANGE_NAME = "mail.exchange.academician.gmm";
    public static final String MAIL_ROUTING_KEY_NAME = "mail.routing.key.academician.gmm";
