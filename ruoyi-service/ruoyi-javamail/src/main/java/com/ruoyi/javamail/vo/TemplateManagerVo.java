...
@Data
@Excel("模板管理信息表")
@ApiModel(value = "com.ruoyi.javamail.vo.TemplateManagerVo",description = "模板管理信息表")
public class TemplateManagerVo implements Serializable {
    ...
    @ApiModelProperty(value = "稿件状态", dataType = "string")
